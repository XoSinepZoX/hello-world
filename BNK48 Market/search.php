<?php
    ...
    if(isset($_POST['search'])) {
		...
		$style = $_POST["style"];
		$mode = $_POST["mode"];
		$membert = $_POST["trademembers"];
		$sett = $_POST["settrade"];
		$stylet = $_POST["styletrade"];
	}
	$compcount = 0;
	$sellingcount = 0;
	$buyingcount = 0;
	...
	<div class = "flex-item">
		<!-- ITEM LOOP BEGIN -->
			<!-- QUARY PART START HERE -->
				<?php
				$q = 'SELECT listings.ItemID,Topic,Pic,Mode,Style,Price,TradeMemName,TradeSetName,TradeStyle,PIC2,PIC3,Username FROM Listings LEFT JOIN buysell ON Listings.ItemID=buysell.ItemID LEFT JOIN trade ON listings.ItemID=trade.ItemID LEFT JOIN users ON listings.UID=users.UID LEFT JOIN PicComp on Listings.ItemID=PicComp.ItemID WHERE Status="Active"';
				if ($member!="") {
				...
				if ($mode=="Trading") {
					if ($membert!="") {
					$q=$q.'AND TradeMemName like '.'"'.$membert.'%"';
				}
					if ($sett!="") {
						$q=$q.'AND TradeSetName like '.'"'.$sett.'%"';
					}
					if ($stylet!="---All---") {
						$q=$q.'AND TradeStyle='.'"'.$stylet.'"';
					}
				}
								...
								<?php  
									if ($row['Style']!='Complete') {
										...
										<?php }
											...
											<img src="img/member/<?php echo $row['Pic'];?>" width="100%" class ="itemstyle-slides centera shadowbox-hover itemstyle-slides<?php echo $compcount?>" onmouseover="getElementById('buying-btt<?php echo $buyingcount ;?>').src='img/button/selling2.png';" onmouseout="getElementById('buying-btt<?php echo $buyingcount ?>').src='img/button/buying.png';">
											<img src="img/member/<?php echo $row['PIC2'];?>" width="100%" class ="itemstyle-slides centera shadowbox-hover itemstyle-slides<?php echo $compcount?>" onmouseover="getElementById('trading-btt<?php echo $tradingcount ;?>').src='img/button/selling2.png';" onmouseout="getElementById('trading-btt<?php echo $tradingcount ?>').src='img/button/trading.png';">
											<img src="img/member/<?php echo $row['PIC3'];?>" width="100%" class ="itemstyle-slides centera shadowbox-hover itemstyle-slides<?php echo $compcount?>" onmouseover="getElementById('buying-btt<?php echo $buyingcount ;?>').src='img/button/selling2.png';" onmouseout="getElementById('buying-btt<?php echo $buyingcount ?>').src='img/button/buying.png';">
										<?php }
										else{ ?>
											<img src="img/member/<?php echo $row['Pic'];?>" width="100%" class ="itemstyle-slides centera shadowbox-hover itemstyle-slides<?php echo $compcount?>" onmouseover="getElementById('trading-btt<?php echo $tradingcount ;?>').src='img/button/selling2.png';" onmouseout="getElementById('trading-btt<?php echo $tradingcount ?>').src='img/button/trading.png';">
											<img src="img/member/<?php echo $row['PIC2'];?>" width="100%" class ="itemstyle-slides centera shadowbox-hover itemstyle-slides<?php echo $compcount?>" onmouseover="getElementById('trading-btt<?php echo $tradingcount ;?>').src='img/button/selling2.png';" onmouseout="getElementById('trading-btt<?php echo $tradingcount ?>').src='img/button/trading.png';">
						...
						<tr>
							<td>
								<?php
									...
									{
										if ($row['Mode']=='Selling') {
											echo '<a href="cart.php"><img src="img/button/atc.png" width="100%" class = "itemstyle-addtocart-btt"></a>';
											$sellingcount = $sellingcount + 1;
										}
										else if ($row['Mode']=='Buying') {

...
<body class = "bgc-bob-color" onload = wrong_psw()>
			...
			<td width="200" height="75">
				...
				<table class = "login-box">
					<form action="checklogin.php" method="POST">
						<tr> 
							<td>Username: </td>
							<td><input type="text" name="username" class = "login-usn" placeholder="Username" required></td>
						</tr>
						<tr> 
							<td>Password: </td>
							<td><input type="password" name="password" class = "login-psw" placeholder="Password" required></td>
						</tr >
						<tr>
							<td colspan="2">
								...
								<tr>
									<td colspan="2">
										<input type="submit" name="login" value="Login" class = "login-login-btt" onclick = "alert_wrong_psw()">
									</td>
								</tr>
								<tr>
									<td>
